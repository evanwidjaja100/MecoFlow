...
Before changing code, read `docs/PRODUCT_REQUIREMENTS.md`, `docs/ARCHITECTURE.md`, `docs/DOMAIN_MODEL.md`, `docs/SECURITY_MODEL.md`, `docs/AUTHORIZATION_MATRIX.md`, `docs/API_CONVENTIONS.md`, `docs/TEST_STRATEGY.md`, `IMPLEMENTATION_STATUS.md`, applicable accepted ADRs, and any nested `AGENTS.md`.
...
- Update affected documentation and `IMPLEMENTATION_STATUS.md` after meaningful work.
