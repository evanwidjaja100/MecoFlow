...
| ------ | ---------------------------------------------------------------------------- | -------------- | --------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| P0R-01 | Inventory dirty worktree, generated/local material, secrets, and migrations  | COMPLETE       | `worktree-reconciliation.md`; executable 112-path comparison relative to entry baseline; repeatable bounded secret-exposure probe | Freeze and approve the new candidate attribution and reconciliation record                           |
